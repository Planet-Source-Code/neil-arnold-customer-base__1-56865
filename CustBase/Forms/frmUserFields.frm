...
Begin VB.Form frmUserFields 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "New / Edit User Contact Fields"
   ClientHeight    =   4800
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9090
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmUserFields.frx":000C
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Label lblBanner 
      BackColor       =   &H00DEE3E6&
      Caption         =   "Add / Edit / Modify Contact User Defined Fields"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmUserFields"
...
Dim rsCUFld As Recordset 'for user field values
...
Private Sub cmdOpts_Click(Index As Integer)
   Const sMOD_NAME As String = "frmUserFields.cmdOpts_Click"
...
Private Sub Form_Load()
   Const sMOD_NAME As String = "frmUserFields.Form_Load"
   On Error GoTo Error_Handler
   ...
   'set main recordsets
   Set rsUserFld = dbContact.OpenRecordset("CUserFields", dbOpenTable)
   Set rsCUFld = dbContact.OpenRecordset("CUFldValues", dbOpenTable)
...
Private Sub Form_Unload(Cancel As Integer)
   Const sMOD_NAME As String = "frmUserFields.Form_Unload"
   On Error GoTo Error_Handler
...
Public Sub InitializeScreen()
   ...
   Const sMOD_NAME As String = "frmUserFields.InitializeScreen"
   On Error GoTo Error_Handler
...
Private Sub LoadUserFields()
   Const sMOD_NAME As String = "frmUserFields.LoadUserFields"
   On Error GoTo Error_Handler
   
   Dim SQL As String
   
   SQL = "SELECT RefNum, Description FROM CUserFields "
...
Private Sub AddNewUserField()
   ...
   Const sMOD_NAME As String = "frmUserFields.AddNewUserField"
   On Error GoTo Error_Handler
...
Private Sub tbrSave_ButtonClick(ByVal Button As MSComctlLib.Button)
   Const sMOD_NAME As String = "frmUserFields.tbrSave_ButtonClick"
   On Error GoTo Error_Handler
...
Private Sub txtValue_KeyPress(KeyAscii As Integer)
   Const sMOD_NAME As String = "frmUserFields.txtValue_KeyPress"
   On Error GoTo Error_Handler
...
Private Sub LoadSavedValue()
   ...
   Const sMOD_NAME As String = "frmUserFields.LoadSavedValue"
   On Error GoTo Error_Handler
   
   Dim SQL As String
   
   SQL = "SELECT RefNum, fkContID, fkUserFld, Value "
   SQL = SQL & "FROM CUFldValues "
...
Private Sub PostEntry()
   Const sMOD_NAME As String = "frmUserFields.PostEntry"
   On Error GoTo Error_Handler
...
Private Sub DeleteUserField()
   Const sMOD_NAME As String = "frmUserFields.DeleteUserField"
   On Error GoTo Error_Handler
   ...
   SQL = "SELECT fkUserFld FROM CUFldValues "
   ...
   With rsList
      If (.RecordCount > 0) Then
         MsgBox "That field is in use in a Contact Record and cannot be removed.", _
...
Delete:
   ...
   DeleteSQL = "DELETE * FROM CUserFields WHERE RefNum = " & m_lngFldID
